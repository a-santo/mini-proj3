...
const controllerComittee = require('../controllers/comittee.controller');
...
// comité
router.post('/committee', controllerComittee.save); //inserir membro do comité
router.get('/committee/', controllerComittee.read); //ler a info de todos os membros do comité
router.get('/committee/:id', controllerComittee.readID); //ler a info de um membro do comité (por id)
router.put('/committee/:id', controllerComittee.updateMember); //atualizar membro do comité
router.delete('/committee/:id', controllerComittee.deleteMember); //apagar membro do comité
